  ...
  toAndroidApp = () => {
    ...
    if (plat.indexOf("Android") > -1 || plat.indexOf("Adr") > -1) {
      ...
      if (ua.match(/MicroMessenger/i) == "micromessenger") {
        ...
        this.open_android(
          `http://cdn-upyun.deshpro.com/deshpro_public/pokerkinglive.apk`
        );
      }
    }
  };
  ...
  render() {
    return (
      ...
      >
        ...
        <div
          className="Download"
          style={this.state.showAndroid ? { marginTop: 70 } : null}
        >
          <div
            style={{
              width: "100%",
          ...
          >
            <a
              target="_blank"
              href="https://apps.apple.com/cn/app/pkc-live/id1486726586"
              className="onclick"
            >
            ...
            <a
              id="android_load"
              target="_blank"
              href="http://cdn-upyun.deshpro.com/deshpro_public/pokerkinglive.apk"
              style={{ marginTop: 20 }}
            >
              <img
                className="andoridDownloadImg2"
                src={Images.androidload}
                alt=""
              />
            </a>
          </div>
